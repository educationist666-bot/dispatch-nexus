...
urlpatterns = [
    ...
    path('hq/pause/<int:company_id>/', views.pause_company, name='pause_company'),   # <--- Added
    path('hq/delete/<int:company_id>/', views.delete_company, name='delete_company'), # <--- Added
    ...
    path('complete/<int:load_id>/', views.complete_load, name='complete_load'),
